# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/build_out/do_ble//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/include/do_ble.h" 1
...
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/include/do_ble.h" 2
...
# 6 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/include/do_ble.h" 2
...
# 2 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 2
...
# 4 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/ble_lib_api.h" 1
# 35 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/ble_lib_api.h"
void ble_controller_init(uint8_t task_priority);
void ble_controller_deinit(void);
# 48 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/ble_lib_api.h"
...
# 60 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/ble_lib_api.h" 3 4
_Bool 
# 60 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blecontroller/ble_inc/ble_lib_api.h"
    ble_controller_sleep_is_ongoing(void);
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 2
...
# 7 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 2


# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/include/do_log.h" 1



# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/include/ulog.h" 1
...
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/include/ulog.h" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/include/app_config.h" 1
# 6 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/include/ulog.h" 2
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/include/do_log.h" 2
# 10 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 2
# 25 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
do_ble_reve_cb_t static_ble_reve_cb = 
# 25 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                                     ((void *)0)
# 25 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                         ;
do_ble_connet_cb_t static_ble_connet_cb = 
# 26 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                                         ((void *)0)
# 26 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                             ;
...
static void connected(struct bt_conn *conn, u8_t err)
{
 ...
 if (err) {
  do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Failed to connect to %s (%u)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", "do_ble.c", 36, addr, err); } while(0);
  return;
 }

 do { bl_printk("\x1b[32m[%10u][%s] " "Connected: %s \r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", addr); } while(0);

    if(static_ble_connet_cb != 
# 42 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                              ((void *)0)
# 42 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                  ){
...
static void disconnected(struct bt_conn *conn, u8_t reason)
{
 ...
 bt_addr_le_to_str(bt_conn_get_dst(conn), addr, sizeof(addr));
 do { bl_printk("\x1b[32m[%10u][%s] " "Disconnected: %s (reason %u)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", addr, reason); } while(0);

    if(static_ble_connet_cb != 
# 55 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                              ((void *)0)
# 55 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                  ){
...
static void le_param_updated(struct bt_conn *conn, u16_t interval,
        u16_t latency, u16_t timeout)
{
 do { bl_printk("\x1b[32m[%10u][%s] " "LE conn param updated: int 0x%04x lat %d to %d" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", interval, latency, timeout); } while(0);
}
...
# 110 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                                                 ((void *)0)
# 110 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                                     , 0);
    }

    if(err){
        do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "Failed to start advertising (err %d)" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble", "do_ble.c", 114, err); } while(0);
    }else{
        do { bl_printk("\x1b[32m[%10u][%s] " "Advertising started" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble"); } while(0);
    }
...
static void bt_ready_cb(int err)
{
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "bt_ready" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble"); } while(0);
}
                   ...
                   u16_t len, u16_t offset, u8_t flags)
{
    ...
    if(static_ble_reve_cb != 
# 137 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
                            ((void *)0)
# 137 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
                                ){
...
# 145 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
((void *)0)
# 145 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
, .user_data = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0xa6920e4c5653) >> 0) & 0xFF), (((0xa6920e4c5653) >> 8) & 0xFF), (((0xa6920e4c5653) >> 16) & 0xFF), (((0xa6920e4c5653) >> 24) & 0xFF), (((0xa6920e4c5653) >> 32) & 0xFF), (((0xa6920e4c5653) >> 40) & 0xFF), (((0xbbd5) >> 0) & 0xFF), (((0xbbd5) >> 8) & 0xFF), (((0x4bd4) >> 0) & 0xFF), (((0x4bd4) >> 8) & 0xFF), (((0x0023) >> 0) & 0xFF), (((0x0023) >> 8) & 0xFF), (((0x53300001) >> 0) & 0xFF), (((0x53300001) >> 8) & 0xFF), (((0x53300001) >> 16) & 0xFF), (((0x53300001) >> 24) & 0xFF) }, })), },
...
# 146 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 146 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0xa6920e4c5653) >> 0) & 0xFF), (((0xa6920e4c5653) >> 8) & 0xFF), (((0xa6920e4c5653) >> 16) & 0xFF), (((0xa6920e4c5653) >> 24) & 0xFF), (((0xa6920e4c5653) >> 32) & 0xFF), (((0xa6920e4c5653) >> 40) & 0xFF), (((0xbbd5) >> 0) & 0xFF), (((0xbbd5) >> 8) & 0xFF), (((0x4bd4) >> 0) & 0xFF), (((0x4bd4) >> 8) & 0xFF), (((0x0023) >> 0) & 0xFF), (((0x0023) >> 8) & 0xFF), (((0x53300003) >> 0) & 0xFF), (((0x53300003) >> 8) & 0xFF), (((0x53300003) >> 16) & 0xFF), (((0x53300003) >> 24) & 0xFF) }, })), .value_handle = 0U, .properties = 0x10, }), }, { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0xa6920e4c5653) >> 0) & 0xFF), (((0xa6920e4c5653) >> 8) & 0xFF), (((0xa6920e4c5653) >> 16) & 0xFF), (((0xa6920e4c5653) >> 24) & 0xFF), (((0xa6920e4c5653) >> 32) & 0xFF), (((0xa6920e4c5653) >> 40) & 0xFF), (((0xbbd5) >> 0) & 0xFF), (((0xbbd5) >> 8) & 0xFF), (((0x4bd4) >> 0) & 0xFF), (((0x4bd4) >> 8) & 0xFF), (((0x0023) >> 0) & 0xFF), (((0x0023) >> 8) & 0xFF), (((0x53300003) >> 0) & 0xFF), (((0x53300003) >> 8) & 0xFF), (((0x53300003) >> 16) & 0xFF), (((0x53300003) >> 24) & 0xFF) }, })), .perm = BT_GATT_PERM_NONE, .read = 
# 146 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 146 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , .write = 
...
# 146 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , }
                                     ...
                                     ,
    { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_16) { .uuid = { BT_UUID_TYPE_16 }, .val = (0x2803), })), .perm = BT_GATT_PERM_READ, .read = bt_gatt_attr_read_chrc, .write = 
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , .user_data = (&(struct bt_gatt_chrc) { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0xa6920e4c5653) >> 0) & 0xFF), (((0xa6920e4c5653) >> 8) & 0xFF), (((0xa6920e4c5653) >> 16) & 0xFF), (((0xa6920e4c5653) >> 24) & 0xFF), (((0xa6920e4c5653) >> 32) & 0xFF), (((0xa6920e4c5653) >> 40) & 0xFF), (((0xbbd5) >> 0) & 0xFF), (((0xbbd5) >> 8) & 0xFF), (((0x4bd4) >> 0) & 0xFF), (((0x4bd4) >> 8) & 0xFF), (((0x0023) >> 0) & 0xFF), (((0x0023) >> 8) & 0xFF), (((0x53300002) >> 0) & 0xFF), (((0x53300002) >> 8) & 0xFF), (((0x53300002) >> 16) & 0xFF), (((0x53300002) >> 24) & 0xFF) }, })), .value_handle = 0U, .properties = 0x08 | 0x04, }), }, { .uuid = ((struct bt_uuid *) (&(struct bt_uuid_128) { .uuid = { BT_UUID_TYPE_128 }, .val = { (((0xa6920e4c5653) >> 0) & 0xFF), (((0xa6920e4c5653) >> 8) & 0xFF), (((0xa6920e4c5653) >> 16) & 0xFF), (((0xa6920e4c5653) >> 24) & 0xFF), (((0xa6920e4c5653) >> 32) & 0xFF), (((0xa6920e4c5653) >> 40) & 0xFF), (((0xbbd5) >> 0) & 0xFF), (((0xbbd5) >> 8) & 0xFF), (((0x4bd4) >> 0) & 0xFF), (((0x4bd4) >> 8) & 0xFF), (((0x0023) >> 0) & 0xFF), (((0x0023) >> 8) & 0xFF), (((0x53300002) >> 0) & 0xFF), (((0x53300002) >> 8) & 0xFF), (((0x53300002) >> 16) & 0xFF), (((0x53300002) >> 24) & 0xFF) }, })), .perm = BT_GATT_PERM_WRITE, .read = 
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , .write = recv_cb, .user_data = 
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c" 3 4
   ((void *)0)
# 152 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/components/do_ble/do_ble.c"
   , }
...
struct bt_gatt_service dis = { .attrs = ble_attrs, .attr_count = ((unsigned long) (((int) sizeof(char[1 - 2 * !(!__builtin_types_compatible_p(__typeof__(ble_attrs), __typeof__(&(ble_attrs)[0])))]) - 1) + (sizeof(ble_attrs) / sizeof((ble_attrs)[0])))), };
...
void do_ble_init(void){
    ...
    do { bl_printk("\x1b[32m[%10u][%s] " "do_ble_init " "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "ble"); } while(0);
