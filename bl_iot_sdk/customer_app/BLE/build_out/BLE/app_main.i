# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c"
...
# 2 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 3 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 4 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 6 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 512 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 8 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 9 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 11 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 12 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 13 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
...
# 21 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/network/ble/blestack/src/include/bluetooth/conn.h"
...
# 14 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c" 2
# 30 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/BLE/BLE/app_main.c"
static void ble_connect_cb(uint8_t status, char *addr){
    if(status == DO_BLE_DEVICE_CONNECT){
        do { bl_printk("\x1b[32m[%10u][%s] " "ble_connect: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "app_main", addr); } while(0);

    }else if(status == DO_BLE_DEVICE_DISCONNECT){
        do { bl_printk("\x1b[32m[%10u][%s] " "ble_disconnect: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "app_main", addr); } while(0);
        ble_start_advertise();
    }
}
...
static void ble_reve_cb(struct bt_conn *conn, const char *buf, u16_t len){
    ...
    char ret_str[10]="";
    do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "ble_reve_buf: %s" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "app_main", "app_main.c", 44, buf); } while(0);
