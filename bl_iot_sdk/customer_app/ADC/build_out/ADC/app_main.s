...
ADC:
.LFB23:
	.file 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
	.loc 1 28 20
	.cfi_startproc
.LVL0:
	.loc 1 29 2
...
.L3:
	...
	call	bl_printk
.LVL10:
	.loc 1 38 5 is_stmt 1 discriminator 4
	li	a0,1000
	call	vTaskDelay
.LVL11:
.LBE12:
	.loc 1 32 13 is_stmt 0 discriminator 4
	j	.L4
.LVL12:
.L2:
.LBB13:
	.loc 1 37 164 discriminator 2
...
.LC1:
	...
	.zero	3
.LC2:
	.string	"\033[31m[%10u][%s %s:%4d] gpio = %d data = %d mv  raw_data=%d \r\n\033[0m\r\n"
	.section	.rodata.user_main.str1.4,"aMS",@progbits,1
	.align	2
.LC3:
	.string	"ADC"
.LC4:
	.string	"\033[32m[%10u][%s] xTaskCreate(ADC) failed\033[0m\r\n"
	.text
.Letext0:
	...
	.file 11 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_adc.h"
...
.LASF34:
	.string	"__tm_year"
.LASF138:
	.string	"/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
.LASF100:
