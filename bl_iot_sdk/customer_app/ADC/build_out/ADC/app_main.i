# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
...
# 2 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 3 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 4 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 6 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 512 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 7 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 8 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2


# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/ulog.h" 1
...
# 5 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/ulog.h" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_config.h" 1
# 6 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/ulog.h" 2
# 11 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
...
# 12 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_pwm.h" 1
# 34 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_pwm.h"
...
# 13 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_adc.h" 1
# 33 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/hal_adc.h"
int hal_adc_init(int sampling_ms);
int hal_adc_add_channel(int gpio_num);
int32_t hal_adc_get_data(int gpio_num);
# 14 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 2
# 28 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
void ADC(void *arg){
 ...
 hal_adc_init( 100);
    ...
    int32_t data = hal_adc_get_data(12);
    int32_t raw_data=hal_adc_get_data(12);

    do { bl_printk("\x1b[31m[%10u][%s %s:%4d] " "gpio = %d data = %d mv  raw_data=%d \r\n" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "app_main", "app_main.c", 37, 12, data,raw_data); } while(0);
...
void user_main(void){
    ...
    if (xTaskCreate(ADC, "ADC", 512, 
# 45 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 3 4
                                    ((void *)0)
# 45 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
                                        , 6, 
# 45 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c" 3 4
                                             ((void *)0)
# 45 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/ADC/ADC/app_main.c"
    ...
    {
        do { bl_printk("\x1b[32m[%10u][%s] " "xTaskCreate(ADC) failed" "\x1b[0m\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "app_main"); } while(0);
    }
