...
app_init_thread:
.LFB76:
	.file 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/TIMER/TIMER/main.c"
	.loc 1 440 1
	.cfi_startproc
.LVL0:
	.loc 1 441 5
...
.LVL11:
	...
	.loc 1 463 5
	lui	a2,%hi(.LANCHOR0)
	lui	a0,%hi(proc_stack_looprt.12448)
.LVL12:
	...
	li	a1,512
	addi	a0,a0,%lo(proc_stack_looprt.12448)
	.loc 1 456 1
	sw	ra,28(sp)
	sw	s0,24(sp)
	sw	s1,20(sp)
...
.LFB67:
 ...
 #APP
# 194 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/TIMER/TIMER/main.c" 1
	csrc mstatus, 8
# 0 "" 2
	.loc 1 195 5
...
.L27:
 ...
 #APP
# 196 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/TIMER/TIMER/main.c" 1
	NOP
# 0 "" 2
 #NO_APP
	j	.L26
...
.LVL174:
	.loc 1 591 5
	lui	a6,%hi(.LANCHOR18)
	lui	a5,%hi(aos_loop_proc_stack.12462)
	lui	a1,%hi(.LC53)
	lui	a0,%hi(aos_loop_proc)
	addi	a6,a6,%lo(.LANCHOR18)
	addi	a5,a5,%lo(aos_loop_proc_stack.12462)
	li	a4,15
	li	a3,0
	li	a2,1024
	addi	a1,a1,%lo(.LC53)
...
.LFE83:
	...
	.globl	_fsymf_info_TIMERmain
	.comm	_fsymf_level_TIMERmain,1,1
	.comm	_fsymc_level_TIMER,1,1
	.section	.bss.aos_loop_proc_stack.12462,"aw",@nobits
	.align	2
	.type	aos_loop_proc_stack.12462, @object
	.size	aos_loop_proc_stack.12462, 4096
aos_loop_proc_stack.12462:
	.zero	4096
	.section	.bss.aos_loop_proc_task.12463,"aw",@nobits
	.align	2
	.set	.LANCHOR18,. + 0
	.type	aos_loop_proc_task.12463, @object
	.size	aos_loop_proc_task.12463, 96
aos_loop_proc_task.12463:
	.zero	96
	.section	.bss.proc_stack_looprt.12448,"aw",@nobits
	.align	2
	.type	proc_stack_looprt.12448, @object
	.size	proc_stack_looprt.12448, 2048
proc_stack_looprt.12448:
	.zero	2048
	.section	.bss.proc_task_looprt.12449,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	proc_task_looprt.12449, @object
	.size	proc_task_looprt.12449, 96
proc_task_looprt.12449:
	.zero	96
	.section	.bss.uxIdleTaskStack.12353,"aw",@nobits
	.align	2
	.set	.LANCHOR4,. + 0
	.type	uxIdleTaskStack.12353, @object
	.size	uxIdleTaskStack.12353, 384
uxIdleTaskStack.12353:
	.zero	384
	.section	.bss.uxTimerTaskStack.12360,"aw",@nobits
	.align	2
	.set	.LANCHOR6,. + 0
	.type	uxTimerTaskStack.12360, @object
	.size	uxTimerTaskStack.12360, 1600
uxTimerTaskStack.12360:
	.zero	1600
	.section	.bss.xIdleTaskTCB.12352,"aw",@nobits
	.align	2
	.set	.LANCHOR3,. + 0
	.type	xIdleTaskTCB.12352, @object
	.size	xIdleTaskTCB.12352, 96
xIdleTaskTCB.12352:
	.zero	96
	.section	.bss.xTimerTaskTCB.12359,"aw",@nobits
	.align	2
	.set	.LANCHOR5,. + 0
	.type	xTimerTaskTCB.12359, @object
	.size	xTimerTaskTCB.12359, 96
xTimerTaskTCB.12359:
	.zero	96
...
xHeapRegions:
	...
	.word	0
	.word	0
	.section	.rodata.__FUNCTION__.12441,"a"
	.align	2
	.set	.LANCHOR1,. + 0
	.type	__FUNCTION__.12441, @object
	.size	__FUNCTION__.12441, 15
__FUNCTION__.12441:
...
.LC13:
	.string	"Task Name %s\r\n"
	.section	.sbss.count.12385,"aw",@nobits
	.set	.LANCHOR9,. + 0
	.type	count.12385, @object
	.size	count.12385, 1
count.12385:
	.zero	1
	.section	.sbss.password.12400,"aw",@nobits
	.align	2
	.set	.LANCHOR15,. + 0
	.type	password.12400, @object
	.size	password.12400, 4
password.12400:
	.zero	4
...
rtos_timer_hdr:
	.zero	4
	.section	.sbss.ssid.12399,"aw",@nobits
	.align	2
	.set	.LANCHOR14,. + 0
	.type	ssid.12399, @object
	.size	ssid.12399, 4
ssid.12399:
	.zero	4
...
conf:
	.string	"CN"
	.zero	5
	.section	.sdata.s_init.12389,"aw"
	.set	.LANCHOR10,. + 0
	.type	s_init.12389, @object
	.size	s_init.12389, 1
s_init.12389:
	.byte	1
...
_fsymc_info_TIMER:
	...
	.word	.LC57
	.section	.static_blogfile_code.TIMERmain,"a"
	.align	2
	.type	_fsymf_info_TIMERmain, @object
	.size	_fsymf_info_TIMERmain, 8
_fsymf_info_TIMERmain:
	.word	_fsymf_level_TIMERmain
	.word	.LC56
	.text
.Letext0:
	...
	.file 42 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/blog/blog_type.h"
	.file 43 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/blog/blog.h"
	.file 44 "/home/melody/work/Doiting_BL/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/stdio.h"
	.file 45 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_chip.h"
	...
	.file 50 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_timer.h"
	.file 51 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_uart.h"
	.file 52 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/hal_drv/bl602_hal/bl_sys.h"
	.file 53 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/blfdt/inc/libfdt.h"
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	aos_loop_proc_stack.12462
	.byte	0x2d
	.4byte	.LASF382
	.byte	0x1
	.2byte	0x23b
	...
	.byte	0x5
	.byte	0x3
	.4byte	aos_loop_proc_task.12463
	.byte	0x2e
	.4byte	0x1fd7
	.4byte	.LBB58
	.4byte	.LBE58-.LBB58
...
.LASF247:
	.string	"icmp"
.LASF495:
	.string	"/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/TIMER/TIMER/main.c"
.LASF323:
	.string	"item"
.LASF214:
	.string	"size"
