# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/build_out/sdk_app_uart_echo//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c"
# 30 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c"
...
# 31 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 32 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 33 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 512 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 34 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 35 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 36 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/utils/include/utils_log.h" 1
# 37 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/utils/include/utils_log.h"
...
# 37 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2
...
# 38 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c" 2

static const char *ci_table_step_init[] = {"[uart_case]", "start"};
static const char *ci_table_step_send[] = {"[uart_case]", "send case"};
static const char *ci_table_step_recv[] = {"[uart_case]", "recv case"};
static const char *ci_table_step_end[] = {"[uart_case]", "end"};
...
static void uart_echo_task(void *arg)
{
    ...
    do { ; bl_printk("[%10u][%s: %s:%4d] " "%s-> fd = %d\r\n", (xPortIsInsideInterrupt())?(xTaskGetTickCountFromISR()):(xTaskGetTickCount()), "\x1b[32mINFO  \x1b[0m", "demo.c", 59, name, fd); ; } while(0==1);
    if (fd < 0) {
        return;
    }
