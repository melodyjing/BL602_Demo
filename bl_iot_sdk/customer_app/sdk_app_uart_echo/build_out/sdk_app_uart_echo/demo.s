...
log_step:
.LFB5:
	.file 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c"
	.loc 1 45 1
	.cfi_startproc
.LVL0:
	.loc 1 46 5
...
.LFE5:
	...
	.section	.text.uart_echo_task,"ax",@progbits
	.align	1
	.type	uart_echo_task, @function
uart_echo_task:
.LFB6:
	.loc 1 50 1
	.cfi_startproc
...
.L4:
	...
	call	bl_printk
.LVL9:
	.loc 1 59 193 is_stmt 1 discriminator 4
	.loc 1 60 5 discriminator 4
	.loc 1 60 8 is_stmt 0 discriminator 4
	blt	s1,zero,.L2
...
.LVL34:
	...
	.cfi_endproc
.LFE6:
	.size	uart_echo_task, .-uart_echo_task
	.section	.text.ci_loop_proc,"ax",@progbits
	.align	1
	.globl	ci_loop_proc
	.type	ci_loop_proc, @function
ci_loop_proc:
.LFB7:
	.loc 1 91 1
	.cfi_startproc
	...
	li	a3,4096
	lui	a2,%hi(.LC6)
	lui	a1,%hi(uart_echo_task)
	lui	a0,%hi(.LC7)
	addi	a3,a3,-2048
	addi	a2,a2,%lo(.LC6)
	addi	a1,a1,%lo(uart_echo_task)
	addi	a0,a0,%lo(.LC7)
	tail	aos_task_new
.LVL35:
	.cfi_endproc
.LFE7:
	.size	ci_loop_proc, .-ci_loop_proc
	.section	.rodata.ci_loop_proc.str1.4,"aMS",@progbits,1
	.align	2
.LC6:
	.string	"/dev/ttyS1"
	.zero	1
...
.LC12:
	.string	"start"
	.section	.rodata.uart_echo_task.str1.4,"aMS",@progbits,1
	.align	2
.LC1:
	.string	"demo.c"
	.zero	1
...
ci_table_step_init:
	.word	.LC8
	.word	.LC12
	.section	.sdata.ci_table_step_recv,"aw"
	.align	2
	.set	.LANCHOR2,. + 0
	.type	ci_table_step_recv, @object
	.size	ci_table_step_recv, 8
ci_table_step_recv:
	.word	.LC8
	.word	.LC10
	.section	.sdata.ci_table_step_send,"aw"
	.align	2
	.set	.LANCHOR1,. + 0
	.type	ci_table_step_send, @object
	.size	ci_table_step_send, 8
ci_table_step_send:
	.word	.LC8
	.word	.LC11
	.text
.Letext0:
	...
	.file 9 "/home/melody/work/Doiting_BL/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/time.h"
	.file 10 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
	.file 11 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/fs/vfs/include/vfs.h"
...
.LASF156:
	.string	"/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/sdk_app_uart_echo/demo.c"
.LASF109:
	.string	"_getdate_err"
.LASF136:
	.string	"pbuf"
.LASF138:
	.string	"send_recv_log"
.LASF96:
	.string	"_add"
.LASF140:
	.string	"log_step"
