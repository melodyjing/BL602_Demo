...
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_uart_echo/build_out/easyflash4//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/ef_env.c"
...
EfErrCode ef_env_init(ef_env const *default_env, size_t default_env_size) {
    ...
    if (!((2 * (16384)))) { ef_log_debug("/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/ef_env.c", 1823, "(%s) has assert failed at %s.\r\n", "ENV_AREA_SIZE", __FUNCTION__); while (1); };

    if (!((2 * (16384)) % (4096) == 0)) { ef_log_debug("/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/ef_env.c", 1825, "(%s) has assert failed at %s.\r\n", "ENV_AREA_SIZE % EF_ERASE_MIN_SIZE == 0", __FUNCTION__); while (1); };

    if (!(((2 * (16384)) / ((4096))) >= 2)) { ef_log_debug("/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/easyflash4/src/ef_env.c", 1827, "(%s) has assert failed at %s.\r\n", "SECTOR_NUM >= 2", __FUNCTION__); while (1); };
