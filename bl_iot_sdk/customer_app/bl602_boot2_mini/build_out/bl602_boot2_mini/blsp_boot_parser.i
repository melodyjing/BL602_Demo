# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/build_out/bl602_boot2_mini//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
# 31 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_common.h" 1
# 33 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_common.h"
...
# 34 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_common.h" 2
...
# 32 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c" 2
...
# 33 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c" 2
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_bootinfo.h" 1
# 34 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_bootinfo.h"
...
# 34 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c" 2
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.h" 1
# 64 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.h"
...
# 35 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c" 2
...
# 36 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c" 2
# 61 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
...
# 98 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
static uint32_t BLSP_Boot_Parse_Is_PKHash_Valid(uint8_t cpuType,uint8_t *pkhash)
{
    if(cpuType==0){
        if(0==memcmp(efuseCfg.pkHashCpu0,pkhash,256/8)){
            return 1;
        }
    }else if(cpuType==1){
        if(0==memcmp(efuseCfg.pkHashCpu1,pkhash,256/8)){
            return 1;
        }
    }
...
# 128 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parse_BootHeader(Boot_Image_Config *bootImgCfg,uint8_t *data)
{
    ...
    if(header->bootCfg.bval.crcIgnore==1&&header->crc32==0xdeadbeef){
        bflb_platform_printf("Crc ignored\r\n");
        crcPass=1;
    }else{
    ...
    if(crcPass){
        ...
        for(i=0;i<2;i++){
            if(0==memcmp((void *)&header->magicCode,"BFNP",
                sizeof(header->magicCode))){
                break;
            }else if(0==memcmp((void *)&header->magicCode,"BFAP",
                sizeof(header->magicCode))){
                break;
            }
        }
        ...
        bflb_platform_printf("sign %d,encrypt:%d\r\n",bootImgCfg->signType, bootImgCfg->encryptType)
                                                    ;


        if(efuseCfg.encrypted[i]!=0){
            if(bootImgCfg->encryptType==0){
                bflb_platform_printf("Encrypt not fit\r\n");
                return BFLB_BOOT2_IMG_BOOTHEADER_ENCRYPT_NOTFIT;
            }
        }

        if(efuseCfg.sign[i]^bootImgCfg->signType){
            bflb_platform_printf("sign not fit\r\n");
            bootImgCfg->signType=efuseCfg.sign[i];
            return BFLB_BOOT2_IMG_BOOTHEADER_SIGN_NOTFIT;
        }

        if(psMode==1 && (!efuseCfg.hbnCheckSign)){

            bootImgCfg->hashIgnore=1;
        }else if((bootImgCfg->hashIgnore==1&& *phash!=0xdeadbeef)||
            efuseCfg.sign[i]!=0 ){

            bootImgCfg->hashIgnore=0;
        }

        BL602_MemCpy_Fast(bootImgCfg->imgHash,header->hash,sizeof(header->hash));
...
# 249 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parse_PKey(Boot_Image_Config *bootImgCfg,uint8_t *data,uint8_t own)
{
    Boot_PK_Config *cfg=(Boot_PK_Config*)data;
    uint32_t pk_hash[256/8/4];

    if(cfg->crc32==BFLB_Soft_CRC32((uint8_t*)cfg,sizeof(Boot_PK_Config)-4)){


        Sec_Eng_SHA256_Update(&shaCtx,SEC_ENG_SHA_ID0,data,256/8 +256/8);
        ...
        if(own==1){
            if(1!=BLSP_Boot_Parse_Is_PKHash_Valid(bootImgCfg->cpuType,
                                                    (uint8_t *)pk_hash)){
                bflb_platform_printf("PK sha error\r\n");
                return BFLB_BOOT2_IMG_PK_HASH_ERROR;
            }
        }
        if(own==1){
            BL602_MemCpy_Fast(bootImgCfg->ecKeyX,cfg->ecKeyX,sizeof(cfg->ecKeyX));
            BL602_MemCpy_Fast(bootImgCfg->ecKeyY,cfg->ecKeyY,sizeof(cfg->ecKeyY));
        }
     }else{
        bflb_platform_printf("PK crc error\r\n");
        return BFLB_BOOT2_IMG_PK_CRC_ERROR;
    }

    return BFLB_BOOT2_SUCCESS;
}
# 293 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parse_Signature(Boot_Image_Config *bootImgCfg,uint8_t *data,uint8_t own)
{
    ...
    if(memcmp(&crc,&cfg->signature[cfg->sigLen],4)==0){
        if(own==1){
            BL602_MemCpy_Fast(bootImgCfg->signature,cfg->signature,cfg->sigLen);
            bootImgCfg->sigLen=cfg->sigLen;
        }else{
            BL602_MemCpy_Fast(bootImgCfg->signature2,cfg->signature,cfg->sigLen);
            bootImgCfg->sigLen2=cfg->sigLen;
        }
    }else{
        bflb_platform_printf("SIG crc error\r\n");
        return BFLB_BOOT2_IMG_SIGNATURE_CRC_ERROR;
    }

    return BFLB_BOOT2_SUCCESS;
}
# 328 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parse_AesIv(Boot_Image_Config *bootImgCfg,uint8_t *data)
{
    ...
    if(cfg->crc32==BFLB_Soft_CRC32(cfg->aesIV,sizeof(cfg->aesIV))){
        ...
        bflb_platform_printf("AES IV crc error\r\n");
        return BFLB_BOOT2_IMG_AES_IV_CRC_ERROR;
    }

    return BFLB_BOOT2_SUCCESS;
}
# 354 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parser_Check_Signature(Boot_Image_Config *bootImgCfg)
{
    int32_t ret=0;

    bflb_platform_printf("%d,%d\r\n",psMode,efuseCfg.hbnCheckSign);
    if(psMode==1&&(!efuseCfg.hbnCheckSign)){
        return BFLB_BOOT2_SUCCESS;
    }
    if(bootImgCfg->signType){
        bflb_platform_printf("Check sig1\r\n");
        ...
        if (ret!=0) {
            bflb_platform_printf("verify failed\n");
            return BFLB_BOOT2_IMG_SIGN_ERROR;
        }
        bflb_platform_printf("Time=%d ms\r\n",bflb_platform_get_time_ms());
    }
    bflb_platform_printf("Success\r\n");
    return BFLB_BOOT2_SUCCESS;
}
# 387 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_boot_parser.c"
int32_t BLSP_Boot_Parser_Check_Hash(Boot_Image_Config *bootImgCfg)
{
    uint32_t imgHashCal[256/8/4];
    ...
    if(!bootImgCfg->hashIgnore){
        ...
        if(memcmp(imgHashCal,bootImgCfg->imgHash ,
          sizeof(bootImgCfg->imgHash))!=0){
            bflb_platform_printf("Hash error\r\n");
            BLSP_Dump_Data(imgHashCal,256/8);
            BLSP_Dump_Data(bootImgCfg->imgHash,256/8);
