# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/build_out/bl602_boot2_mini//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
# 31 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
...
# 32 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 33 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 34 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 36 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
uint32_t BLSP_Boot2_Get_Baudrate(void);
uint8_t BLSP_Boot2_Get_TX_GPIO(void);
# 37 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 38 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 39 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
...
# 40 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c" 2
# 70 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
extern SEC_Eng_SHA256_Ctx shaCtx;
# 99 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
...
# 143 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
static int32_t BLSP_MediaBoot_Read_Signaure(uint32_t addr,uint32_t *len)
{
    ...
    BL602_MemCpy_Fast(boot2ReadBuf,&sig_len,sizeof(sig_len));
    addr+=(sig_len+4);
    *len=sig_len;

    return ret;
}
# 181 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
static int32_t BLSP_MediaBoot_Parse_One_FW(Boot_Image_Config *bootImgCfg,uint32_t bootheaderAddr,uint32_t imgAddr)
{
    ...
    bflb_platform_printf("R header from %08x\r\n",addr);
...
# 330 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
int32_t __attribute__((section(".tcm_code"))) BLSP_MediaBoot_Read(uint32_t addr,uint8_t *data, uint32_t len)
{
    XIP_SFlash_Read_Via_Cache_Need_Lock(0x23000000 +addr,data,len);

    return BFLB_BOOT2_SUCCESS;
}
# 347 "/home/melody/work/BL602_Demo/bl_iot_sdk/customer_app/bl602_boot2_mini/bl602_boot2_mini/blsp_media_boot.c"
int32_t BLSP_MediaBoot_Main(uint32_t cpuBootheaderAddr[2],uint8_t cpuRollBack[2],uint8_t rollBack)
{
    int32_t ret;
    uint32_t i=0;
    uint32_t validImgFound=0;
    uint32_t bootHeaderAddr[2];

    bflb_platform_printf("Media boot main\r\n");
    ...
    if(validImgFound!=cpuCount && 1==rollBack){
        ...
        if(bootHeaderAddr[1]==0 && validImgFound==1){
            bflb_platform_printf("Found One img Only\r\n");
        }else{
            bflb_platform_printf("Image roll back\r\n");
            return BFLB_BOOT2_IMG_Roll_Back;
        }
    }
    if(validImgFound==0){
        bflb_platform_printf("no valid img found\r\n");
    ...
    bflb_platform_printf("CPU Count %d,%d\r\n",cpuCount,bootImgCfg[0].haltCPU1);
