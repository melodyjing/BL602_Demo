...
.Ltext0:
	...
	.section	.text.UART_IntHandler,"ax",@progbits
	.align	1
	.type	UART_IntHandler, @function
UART_IntHandler:
.LFB8:
	.file 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
	.loc 1 101 1
	.cfi_startproc
.LVL0:
	.loc 1 102 5
...
.L6:
	...
	.loc 1 126 7
	beq	a5,zero,.L8
	.loc 1 126 56 discriminator 1
	andi	a5,s1,4
	.loc 1 126 40 discriminator 1
	bne	a5,zero,.L8
	.loc 1 127 9 is_stmt 1
	.loc 1 127 34 is_stmt 0
	lui	a4,%hi(.LANCHOR1)
	slli	a5,s0,5
	addi	a4,a4,%lo(.LANCHOR1)
	add	a5,a4,a5
...
.L9:
	...
	.loc 1 140 7
	beq	a5,zero,.L11
	.loc 1 140 56 discriminator 1
	andi	a5,s1,16
	.loc 1 140 40 discriminator 1
	bne	a5,zero,.L11
	.loc 1 141 9 is_stmt 1
	.loc 1 141 47 is_stmt 0
	li	a5,16
	.loc 1 142 34
	lui	a4,%hi(.LANCHOR1)
	.loc 1 141 47
...
.L14:
	...
	.loc 1 156 7
	beq	a5,zero,.L16
	.loc 1 156 56 discriminator 1
	andi	a5,s1,64
	.loc 1 156 40 discriminator 1
	bne	a5,zero,.L16
	.loc 1 157 9 is_stmt 1
	.loc 1 157 34 is_stmt 0
	lui	a4,%hi(.LANCHOR1)
	slli	a5,s0,5
	addi	a4,a4,%lo(.LANCHOR1)
	add	a5,a4,a5
...
.LVL15:
	...
	.cfi_endproc
.LFE8:
	.size	UART_IntHandler, .-UART_IntHandler
...
.Letext0:
	...
	.file 10 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_uart.h"
...
.LASF288:
	.string	"/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_uart.c"
.LASF93:
	.string	"_stdin"
.LASF126:
