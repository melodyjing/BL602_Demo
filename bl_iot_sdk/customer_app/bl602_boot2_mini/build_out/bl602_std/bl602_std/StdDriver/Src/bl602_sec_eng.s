...
.LFB42:
	.file 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c"
	.loc 1 1668 1
	.cfi_startproc
.LVL0:
	.loc 1 1669 5
...
.LVL298:
 ...
 #APP
# 949 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 950 5
# 950 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 951 5
.LVL299:
...
.LBB42:
.LBB43:
	.file 2 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/RISCV/Core/Include/cmsis_compatible_gcc.h"
	.loc 2 100 5
	.loc 2 102 5
	.loc 2 103 5
	.loc 2 104 5
...
.LVL515:
 ...
 #APP
# 1304 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1305 5
# 1305 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1306 5
# 1306 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1307 5
# 1307 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
 #NO_APP
	li	a5,15998976
...
.LVL531:
 ...
 #APP
# 1384 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1385 5
# 1385 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1386 5
# 1386 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
	.loc 1 1387 5
# 1387 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c" 1
	nop
# 0 "" 2
 #NO_APP
	li	a3,15998976
...
.LBB200:
	...
	lw	a5,512(a4)
.LVL947:
	.loc 1 2737 13 is_stmt 1
	.loc 1 2737 27 is_stmt 0
	andi	a3,a5,256
	.loc 1 2737 15
	beq	a3,zero,.L382
	.loc 1 2739 17 is_stmt 1
	.loc 1 2739 86 is_stmt 0
	ori	a5,a5,512
.LVL948:
	.loc 1 2739 73
	sw	a5,512(a4)
	.loc 1 2741 17 is_stmt 1
	.loc 1 2741 36 is_stmt 0
	lui	a5,%hi(.LANCHOR1)
	lw	a5,%lo(.LANCHOR1)(a5)
	.loc 1 2741 19
	beq	a5,zero,.L382
	.loc 1 2742 21 is_stmt 1
	jalr	a5
.LVL949:
.L382:
.LBE200:
.LBE201:
	.loc 1 3040 1 is_stmt 0
	lw	ra,140(sp)
	.cfi_restore 1
	lw	t0,136(sp)
	.cfi_restore 5
...
.LFE85:
	...
	.section	.text.SEC_PKA_IRQHandler,"ax",@progbits
	.align	1
	.globl	SEC_PKA_IRQHandler
	.type	SEC_PKA_IRQHandler, @function
SEC_PKA_IRQHandler:
.LFB86:
...
.LVL951:
	...
	.loc 1 2772 86 is_stmt 0
	ori	a5,a5,512
.LVL952:
	.loc 1 2772 73
	sw	a5,768(a4)
	.loc 1 2774 17 is_stmt 1
	.loc 1 2774 36 is_stmt 0
	lui	a5,%hi(.LANCHOR1+12)
	lw	a5,%lo(.LANCHOR1+12)(a5)
	.loc 1 2774 19
	beq	a5,zero,.L390
	.loc 1 2775 21 is_stmt 1
	jalr	a5
.LVL953:
.L390:
.LBE206:
.LBE207:
	.loc 1 3053 1 is_stmt 0
	lw	ra,140(sp)
	.cfi_restore 1
	lw	t0,136(sp)
	.cfi_restore 5
	...
	.cfi_endproc
.LFE86:
	.size	SEC_PKA_IRQHandler, .-SEC_PKA_IRQHandler
	.section	.text.SEC_AES_IRQHandler,"ax",@progbits
	.align	1
	.globl	SEC_AES_IRQHandler
	.type	SEC_AES_IRQHandler, @function
SEC_AES_IRQHandler:
.LFB87:
...
.LBB212:
	...
	lw	a5,256(a4)
.LVL955:
	.loc 1 2748 13 is_stmt 1
	.loc 1 2748 27 is_stmt 0
	andi	a3,a5,256
	.loc 1 2748 15
	beq	a3,zero,.L398
	.loc 1 2750 17 is_stmt 1
	.loc 1 2750 86 is_stmt 0
	ori	a5,a5,512
.LVL956:
	.loc 1 2750 73
	sw	a5,256(a4)
	.loc 1 2752 17 is_stmt 1
	.loc 1 2752 36 is_stmt 0
	lui	a5,%hi(.LANCHOR1+4)
	lw	a5,%lo(.LANCHOR1+4)(a5)
	.loc 1 2752 19
	beq	a5,zero,.L398
	.loc 1 2753 21 is_stmt 1
	jalr	a5
.LVL957:
.L398:
.LBE212:
.LBE213:
	.loc 1 3066 1 is_stmt 0
	lw	ra,140(sp)
	.cfi_restore 1
	lw	t0,136(sp)
	.cfi_restore 5
	...
	.cfi_endproc
.LFE87:
	.size	SEC_AES_IRQHandler, .-SEC_AES_IRQHandler
	.section	.text.SEC_SHA_IRQHandler,"ax",@progbits
	.align	1
	.globl	SEC_SHA_IRQHandler
	.type	SEC_SHA_IRQHandler, @function
SEC_SHA_IRQHandler:
.LFB88:
	.loc 1 3077 1 is_stmt 1
	.cfi_startproc
	addi	sp,sp,-144
	.cfi_def_cfa_offset 144
	sw	a3,112(sp)
...
.LVL959:
	...
	.loc 1 2759 27 is_stmt 0
	andi	a3,a5,256
	.loc 1 2759 15
	beq	a3,zero,.L406
	.loc 1 2761 17 is_stmt 1
	.loc 1 2761 84 is_stmt 0
	ori	a5,a5,512
.LVL960:
	.loc 1 2761 71
	sw	a5,0(a4)
	.loc 1 2763 17 is_stmt 1
	.loc 1 2763 36 is_stmt 0
	lui	a5,%hi(.LANCHOR1+8)
	lw	a5,%lo(.LANCHOR1+8)(a5)
	.loc 1 2763 19
	beq	a5,zero,.L406
	.loc 1 2764 21 is_stmt 1
	jalr	a5
.LVL961:
.L406:
.LBE218:
.LBE219:
	...
	.cfi_endproc
.LFE88:
	.size	SEC_SHA_IRQHandler, .-SEC_SHA_IRQHandler
	.section	.text.SEC_CDET_IRQHandler,"ax",@progbits
	.align	1
	.globl	SEC_CDET_IRQHandler
	.type	SEC_CDET_IRQHandler, @function
SEC_CDET_IRQHandler:
.LFB89:
	.loc 1 3090 1 is_stmt 1
	.cfi_startproc
	addi	sp,sp,-144
	.cfi_def_cfa_offset 144
	sw	a5,104(sp)
...
.LBB222:
.LBB223:
	.loc 1 2781 32 is_stmt 0
	lui	a5,%hi(.LANCHOR1+16)
.LBE223:
.LBE222:
	.loc 1 3090 1
	fsw	ft8,12(sp)
...
.LBB225:
	.loc 1 2781 15
	beq	a5,zero,.L414
	.loc 1 2782 17 is_stmt 1
	jalr	a5
.LVL963:
.L414:
.LBE225:
.LBE227:
	.loc 1 3092 1 is_stmt 0
	lw	ra,140(sp)
	.cfi_restore 1
	lw	t0,136(sp)
	.cfi_restore 5
	...
	.cfi_endproc
.LFE89:
	.size	SEC_CDET_IRQHandler, .-SEC_CDET_IRQHandler
	.section	.text.SEC_GMAC_IRQHandler,"ax",@progbits
	.align	1
	.globl	SEC_GMAC_IRQHandler
	.type	SEC_GMAC_IRQHandler, @function
SEC_GMAC_IRQHandler:
.LFB90:
...
.LBB232:
	...
	lw	a5,1280(a4)
.LVL965:
	.loc 1 2787 13 is_stmt 1
	.loc 1 2787 27 is_stmt 0
	andi	a3,a5,256
	.loc 1 2787 15
	beq	a3,zero,.L420
	.loc 1 2789 17 is_stmt 1
	.loc 1 2789 86 is_stmt 0
	ori	a5,a5,512
.LVL966:
	.loc 1 2789 73
	sw	a5,1280(a4)
	.loc 1 2791 17 is_stmt 1
	.loc 1 2791 36 is_stmt 0
	lui	a5,%hi(.LANCHOR1+20)
	lw	a5,%lo(.LANCHOR1+20)(a5)
	.loc 1 2791 19
	beq	a5,zero,.L420
	.loc 1 2792 21 is_stmt 1
	jalr	a5
.LVL967:
.L420:
.LBE232:
.LBE233:
	...
	.cfi_endproc
.LFE90:
	.size	SEC_GMAC_IRQHandler, .-SEC_GMAC_IRQHandler
...
.Letext0:
	...
	.file 11 "/home/melody/work/BL602_Demo/bl_iot_sdk/toolchain/riscv/Linux/riscv64-unknown-elf/include/string.h"
...
.LASF406:
	.string	"/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_sec_eng.c"
.LASF301:
	.string	"cout"
.LASF204:
