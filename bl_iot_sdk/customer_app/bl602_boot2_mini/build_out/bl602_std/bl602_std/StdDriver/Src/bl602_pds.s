...
PDS_Reset:
.LFB8:
	.file 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_pds.c"
	.loc 1 101 1
	.cfi_startproc
	.loc 1 102 5
.LVL0:
...
.LFE23:
	...
	.section	.text.PDS_WAKEUP_IRQHandler,"ax",@progbits
	.align	1
	.globl	PDS_WAKEUP_IRQHandler
	.type	PDS_WAKEUP_IRQHandler, @function
...
.LVL139:
	.loc 1 763 11
	beq	a0,zero,.L56
	.loc 1 763 63 discriminator 1
	slli	a5,s0,2
	add	a5,s1,a5
	lw	a5,0(a5)
	.loc 1 763 38 discriminator 1
	beq	a5,zero,.L56
...
.L56:
	addi	s0,s0,1
.LVL141:
	.loc 1 762 5 is_stmt 0 discriminator 2
	bne	s0,s2,.L57
.LBE4:
...
.LVL142:
	...
	.cfi_endproc
.LFE29:
	.size	PDS_WAKEUP_IRQHandler, .-PDS_WAKEUP_IRQHandler
...
.Letext0:
	...
	.file 10 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_pds.h"
...
.LASF325:
	.string	"/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_pds.c"
.LASF23:
	.string	"_next"
.LASF170:
	.string	"WbRst"
