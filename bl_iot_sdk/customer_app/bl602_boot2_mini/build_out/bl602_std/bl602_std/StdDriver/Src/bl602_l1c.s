...
L1C_Set_Wrap:
.LFB8:
	.file 1 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_l1c.c"
	.loc 1 102 1
	.cfi_startproc
.LVL0:
	.loc 1 103 5
...
.LFE18:
	...
	.section	.text.L1C_BMX_ERR_IRQHandler,"ax",@progbits
	.align	1
	.globl	L1C_BMX_ERR_IRQHandler
	.type	L1C_BMX_ERR_IRQHandler, @function
...
.L22:
	...
	lui	s0,%hi(.LC0)
.L21:
	.loc 1 362 5 is_stmt 1 discriminator 1
	.loc 1 363 9 discriminator 1
	addi	a0,s0,%lo(.LC0)
...
.LVL53:
	...
	.cfi_endproc
.LFE19:
	.size	L1C_BMX_ERR_IRQHandler, .-L1C_BMX_ERR_IRQHandler
...
.LFE20:
	...
	.section	.text.L1C_BMX_TO_IRQHandler,"ax",@progbits
	.align	1
	.globl	L1C_BMX_TO_IRQHandler
	.type	L1C_BMX_TO_IRQHandler, @function
...
.LVL61:
	...
	.cfi_endproc
.LFE21:
	.size	L1C_BMX_TO_IRQHandler, .-L1C_BMX_TO_IRQHandler
	.section	.rodata.L1C_BMX_ERR_IRQHandler.str1.4,"aMS",@progbits,1
	.align	2
.LC0:
	.string	"L1C_BMX_ERR_IRQHandler\r\n"
	.section	.rodata.L1C_BMX_TO_IRQHandler.str1.4,"aMS",@progbits,1
	.align	2
.LC1:
	.string	"L1C_BMX_TO_IRQHandler\r\n"
...
.Letext0:
	...
	.file 9 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Inc/bl602_l1c.h"
	.file 10 "/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/Common/platform_print/bflb_platform.h"
...
.LASF102:
	.string	"_rand_next"
.LASF177:
	.string	"/home/melody/work/BL602_Demo/bl_iot_sdk/components/bl602/bl602_std/bl602_std/StdDriver/Src/bl602_l1c.c"
.LASF56:
	.string	"_seek"
.LASF70:
	.string	"_stderr"
