# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/build_out/sdk_app_ble_sync//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c"
# 30 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c"
# 1 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.h" 1
# 32 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.h"
...
# 33 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.h" 2
...
# 31 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c" 2
...
# 37 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c" 2
...
# 512 "/home/melody/work/Doiting_BL/bl_iot_sdk/components/stage/yloop/include/aos/kernel.h"
    ...
    void aos_start(void);
# 38 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c" 2
...
# 39 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c" 2
...
# 40 "/home/melody/work/Doiting_BL/bl_iot_sdk/customer_app/sdk_app_ble_sync/sdk_app_ble_sync/wifi_prov_api.c" 2

int wifi_prov_api_event_trigger_connect(struct wifi_conn *info)
{
    if (aos_post_event(0x0002, 16, (unsigned long)info) >= 0) {
...
int wifi_prov_api_event_trigger_disconnect(void)
{
    if (aos_post_event(0x0002, 17, 0) >= 0) {
...
int wifi_prov_api_event_trigger_scan(void(*complete)(void *))
{
    if (aos_post_event(0x0002, 18, (unsigned long)complete) >= 0) {
...
int wifi_prov_api_event_state_get(void(*state_get)(void *))
{
    if (aos_post_event(0x0002, 19, (unsigned long)state_get) >= 0) {
        puts("[APP] [PROV] trigger scan event OK\r\n");
    } else {
        puts("[APP] [PROV] trigger scan event failed\r\n");
        return -1;
